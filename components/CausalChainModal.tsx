        ...
        <Modal isOpen={!!log} onClose={onClose} title="Causal Chain Trace">
            {log && (
                <>
                    ...
                    <div className="trace-section"> <h4>3. Decision & Reasoning</h4> <p><strong>Selected Skill:</strong> {log.skill ?? 'N/A'}</p> <p><strong>Input:</strong> "{log.input ?? 'N/A'}"</p> <p className="reasoning-text"><strong>Reasoning:</strong> "{log.decisionContext?.reasoning ?? 'N/A'}"</p> </div>
